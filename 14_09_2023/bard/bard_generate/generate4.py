...
input_json_file_path = '/Users/nghiempt/Corporation/scientific_research/paper_policy/14_09_2023/bard/bard_generate/input4.json'       # Provide the path to the input JSON file
output_json_file_path = '/Users/nghiempt/Corporation/scientific_research/paper_policy/14_09_2023/bard/bard_generate/output4.json'      # Provide the path to the output JSON file
