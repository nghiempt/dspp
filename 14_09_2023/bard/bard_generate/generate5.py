...
input_json_file_path = '/Users/nghiempt/Corporation/scientific_research/paper_policy/14_09_2023/bard/bard_generate/input5.json'       # Provide the path to the input JSON file
output_json_file_path = '/Users/nghiempt/Corporation/scientific_research/paper_policy/14_09_2023/bard/bard_generate/output5.json'      # Provide the path to the output JSON file
