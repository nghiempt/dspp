...
class DATASET_MAKER:
    ...
    def generate_dataset(package_name: str, id):
        ...
        new_row = [str(id), appName, package_name, "15-09-2023", developer, categories, numberOfDownload, "https://play.google.com/store/apps/datasafety?id=" + package_name, pp_link]
        print(str(new_row))
        return new_row

if __name__ == "__main__":
    df = pd.read_csv('app_pkg.csv')
    ...
    new_df.to_csv("resource_dataset.csv", index=False)
