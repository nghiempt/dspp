...
with open('/Users/nghiempt/Corporation/scientific_research/paper_policy/step-02-approach/gpt3.5-draft/assets/resources/dataset_random_gpt4.0.json', 'w') as json_file:
